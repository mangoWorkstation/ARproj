...
import com.mango.arproj.vuforia.SampleAppRenderer;
import com.mango.arproj.vuforia.SampleAppRendererControl;
import com.mango.arproj.vuforia.SampleApplicationSession;
import com.mango.arproj.vuforia.utils.CubeShaders;
import com.mango.arproj.vuforia.utils.SampleUtils;
import com.mango.arproj.vuforia.utils.Teapot;
...
public class UserDefinedTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    public UserDefinedTargetRenderer(ARCameraActivity activity,
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            SampleUtils.checkGLError("ARCameraActivity renderFrame");
        }
