...
public class RefFreeFrameGL
{
    ...
    String textureNames[] = {
            "ARCameraActivity/viewfinder_crop_marks_portrait.png",
            "ARCameraActivity/viewfinder_crop_marks_landscape.png" };
    Texture[] textures;
    ...
    public RefFreeFrameGL(ARCameraActivity activity,
